...
import { Settings, Search, Trash2, Loader2 } from "lucide-react";
    ...
    return (
      <div className="p-6 min-h-screen bg-gradient-to-b from-white to-blue-50">
        ...
        <div className="flex flex-col items-center justify-center h-[60vh]">
          ...
          <p className="text-blue-800 text-lg font-medium">Cargando administradores...</p>
        </div>
      </div>
    );
  }
        ...
        <Card className="border-red-200 shadow-md">
          <CardContent className="p-6">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-xl font-bold text-red-700 mb-2">Error al cargar los administradores</h2>
          ...
          <Table>
            ...
            <TableBody>
              {currentAdmins.length > 0 ? (
                currentAdmins.map((admin: Administrador) => (
                  <TableRow key={admin.id} className="hover:bg-blue-50 transition-colors">
                    <TableCell className="font-medium text-blue-900">{admin.nombre}</TableCell>
                    <TableCell className="text-gray-600">{admin.apellido}</TableCell>
                    <TableCell className="text-gray-600">{admin.correo}</TableCell>
                  ...
                  <TableCell colSpan={5} className="text-center py-8 text-gray-500">
                    {searchTerm ? (
                      <div className="flex flex-col items-center">
                        ...
                        <p>
                          No se encontraron administradores que coincidan con "
