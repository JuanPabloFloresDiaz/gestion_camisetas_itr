...
import { updateTipoCamisa } from "@/services/tipo_camisas.service"; // Importar servicio de tipos de camisas
...
interface UpdateTipoCamisaModalProps {
  tipoCamisa: TipoCamisa; // El tipo de camisa a actualizar
}
...
export default function UpdateTipoCamisaModal({ tipoCamisa }: UpdateTipoCamisaModalProps) {
  ...
  const onSubmit: SubmitHandler<TipoCamisaFormValues> = async (data) => {
    try {
      // Agregar el id del tipo de camisa al objeto data
            ...
            <ModalBody className="p-4 overflow-y-auto">
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="grid grid-cols-1 gap-4">
                  ...
                  {/* Descripción */}
                  <div>
                    <Label htmlFor="descripcion" className="text-yellow-500">
                      Descripción
                    </Label>
                    <div className="relative mt-2">
                      <Input
